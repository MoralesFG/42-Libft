...
#    Updated: 2022/12/28 10:38:59 by framoral         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
.PHONY: all clean fclean bonus re # Para que use nuestras reglas creadas en lugar de las que ya pueden existir para make, para que sea mas espeficico #